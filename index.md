...
[景氣溫度計]({{ site.baseurl }}/climate-index/){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[系統健康度](#系統健康度){: .btn .fs-5 .mb-4 .mb-md-0 }
...
| 報告 | 週次 | 說明 |
|:-----|:-----|:-----|
| [景氣溫度計]({{ site.baseurl }}/climate-index/) | W06 | 就業市場綜合溫度判讀 |
| [技能漂移]({{ site.baseurl }}/skills-drift/) | W06 | 技能標籤上升/下降榜 |
| [產業分層]({{ site.baseurl }}/industry-segments/) | W06 | 各產業用人方向與趨勢 |
| [薪資帶]({{ site.baseurl }}/salary-bands/) | W06 | 跨產業跨地區薪資比較 |
| [求職策略]({{ site.baseurl }}/career-strategy/) | W06 | 技能缺口→學習路徑→職缺 |
...
| Mode | 狀態 | 最新報告 |
|:-----|:-----|:---------|
| climate_index | ✅ | 2026-W06 |
| skills_drift | ✅ | 2026-W06（基線版） |
| industry_segments | ✅ | 2026-W06 |
| salary_bands | ✅ | 2026-W06 |
| career_strategy | ✅ | 2026-W06 |
