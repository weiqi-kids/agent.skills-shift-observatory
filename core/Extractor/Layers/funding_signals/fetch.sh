...
FEED_NAMES=("techcrunch_funding" "crunchbase_news" "venturebeat_funding")
FEED_URLS=("https://techcrunch.com/tag/funding/feed/" "https://news.crunchbase.com/feed/" "https://venturebeat.com/category/business/feed/")

echo "=== funding_signals 資料擷取開始 ==="
echo "時間戳: $TIMESTAMP"
echo ""
